          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            <div className="md:col-span-5 relative">
              ...
              <input
                ...
                className="pl-10 w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-800"
                value={searchQuery}
            ...
            <div className="md:col-span-2 relative">
              ...
              <select
                className="pl-10 w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 appearance-none text-gray-800"
                value={selectedTime}
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {searchResults.map((location) => (
                    <tr key={location.id}>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm">
                        <button className="px-3 py-1 bg-indigo-100 text-indigo-700 rounded-md font-medium hover:bg-indigo-200 transition duration-150">
                          Reserve
                        </button>
                      </td>
                    </tr>
        ...
        <div className="mt-6 bg-indigo-50 p-4 rounded-lg">
          ...
          <ul className="text-sm text-gray-600 space-y-2">
            <li className="flex items-start">
              <span className="inline-block w-2 h-2 bg-indigo-500 rounded-full mr-2 mt-1.5"></span>
              <span>Parking spaces fill up quickly during peak hours (7-9 AM and 4-6 PM).</span>
            </li>
            <li className="flex items-start">
              <span className="inline-block w-2 h-2 bg-indigo-500 rounded-full mr-2 mt-1.5"></span>
              <span>Reserve your spot in advance to guarantee availability.</span>
            </li>
            <li className="flex items-start">
              <span className="inline-block w-2 h-2 bg-indigo-500 rounded-full mr-2 mt-1.5"></span>
              <span>Check multiple locations for better availability during busy times.</span>
            </li>
          </ul>
        </div>
      </div>
